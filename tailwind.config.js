  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        cyan:   { DEFAULT: '#a855f7', soft: '#d8b4fe', dim: '#7c3aed' },
        teal:   { DEFAULT: '#7c3aed', light: '#c084fc' },
      ...
      boxShadow: {
        ...
        'blue-lg':     '0 8px 40px rgba(168,85,247,0.28)',
        'blue-glow':   '0 0 24px rgba(168,85,247,0.6)',
