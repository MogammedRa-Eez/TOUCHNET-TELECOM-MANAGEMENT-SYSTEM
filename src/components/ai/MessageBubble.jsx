...
export default function MessageBubble({ message }) {
  ...
  return (
    <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
      {!isUser && (
        <div className="h-7 w-7 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center mt-0.5 flex-shrink-0">
              ...
              <ReactMarkdown
                ...
                components={{
                  ...
                  code: ({ inline, children }) => inline
                    ...
                    : <pre className="bg-slate-900 text-slate-100 rounded-lg p-3 overflow-x-auto my-2"><code>{children}</code></pre>,
