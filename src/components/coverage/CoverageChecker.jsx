 ...
 * Used by Dashboard and CustomerPortalMain.
 */
    ...
    >
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg,#00b4b4,#00d4d4,rgba(255,255,255,0.5),#8B1A1A,transparent)",
          }}
        />
        ...
        <div className="p-6 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-[12px]" style={{ color: "rgba(255,255,255,0.4)" }}>
              View all available providers, plans, and pricing for any South African
              address on our interactive coverage map.
            </p>
          </div>
          ...
          <div className="flex gap-3 w-full">
            ...
            <Link
              ...
              style={{
                ...
                boxShadow: "0 4px 16px rgba(0,180,180,0.35)",
              }}
            >
              Open Coverage Map →
            </Link>
