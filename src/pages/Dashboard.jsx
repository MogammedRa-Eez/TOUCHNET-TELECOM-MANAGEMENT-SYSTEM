...
export default function Dashboard() {
  ...
  return (
    <div className="p-4 lg:p-6 space-y-5" style={{ background: "#f0f4ff" }}>
      ...
      {/* WhatsApp AI Assistant Button */}
      <a
        href={base44.agents.getWhatsAppConnectURL('touchnet_assistant')}
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-full shadow-xl text-white text-sm font-semibold transition-all hover:scale-105 active:scale-95"
