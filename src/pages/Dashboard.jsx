...
export default function Dashboard() {
  ...
  return (
    <div className="p-5 lg:p-8 space-y-6 max-w-[1600px] mx-auto" onClick={() => setActiveKPI(null)}>
      ...
      {/* ── Ticker ── */}
      <div className="relative overflow-hidden rounded-xl h-9 flex items-center"
      ...
      <Section title="Network Coverage" icon={Globe} badge={`${onlineNodes}/${nodes.length} online`} color="#00b4b4" className="section-reveal section-reveal-delay-2">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
          <div className="lg:col-span-3 rounded-3xl overflow-hidden relative"
            style={{ background: "linear-gradient(135deg, #0d1010 0%, #111111 50%, #0a0d0d 100%)", border: "1px solid rgba(0,180,180,0.28)", boxShadow: "0 8px 48px rgba(0,0,0,0.6), inset 0 1px 0 rgba(0,212,212,0.08), 0 0 40px rgba(0,180,180,0.04)", minHeight: 600 }}>
