...
function SidebarNav({ currentPageName, mobileOpen, setMobileOpen, collapsed, setCollapsed }) {
  ...
  return (
    <aside
      ...
      `}
      style={{ background: "linear-gradient(180deg, #111936 0%, #1a2550 60%, #111936 100%)" }}>
      ...
      <div className="bg-transparent flex items-center justify-between px-3 h-[64px] flex-shrink-0" style={{ borderBottom: "1px solid rgba(99,102,241,0.2)" }}>
        <div className="flex items-center overflow-hidden flex-1">
          ...
          <img src={LOGO_URL} alt="TouchNet Logo" className="h-8 w-auto object-contain" style={{ filter: "brightness(0) invert(1)" }} />
          }
        </div>
        {/* Mobile close */}
