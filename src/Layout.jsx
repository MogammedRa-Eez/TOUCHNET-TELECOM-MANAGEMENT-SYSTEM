    ...
    `} style={{ background: "#0a0f1e" }}>
      ...
      <div className="flex items-center justify-between px-5 h-[64px] flex-shrink-0" style={{ borderBottom: "1px solid rgba(220,38,38,0.15)" }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="bg-slate-950 text-[#fcfcfc] font-bold tracking-tight leading-tight">ADMIN USER</h1>
      ...
      {/* Nav */}
      <nav className="mr-4 mb-24 ml-1 pt-8 pb-32 pl-6 rounded-[10px] flex-1 overflow-y-auto tn-sidebar space-y-0.5">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              onClick={() => setMobileOpen(false)} className="text-slate-400 my-4 px-5 py-3 text-sm font-medium rounded-md flex items-center gap-3 transition-all duration-150 group relative hover:text-slate-200 nav-item-hover">
      ...
      {/* Footer */}
      <div className="px-4 py-4 flex-shrink-0" style={{ borderTop: "1px solid rgba(220,38,38,0.1)" }}>
        <div className="text-center">
          <p className="text-slate-50 mono">© TOUCHNET</p>
        </div>
      </div>
    </aside>);
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden main-content">
        <header className="h-[64px] flex items-center px-4 lg:px-6 flex-shrink-0 z-30 gap-4 topbar-border" style={{ background: "#0a0f1e" }}>
          ...
          <div className="flex-1">
            ...
            <p className="text-red-800 font-semibold text-left underline uppercase hidden sm:block mono">MOGAMMED RA-EEZ ZARDAD / admin</p>
          </div>
